import {GET_CONTACTS_FAIL,GET_CONTACTS_LOAD,GET_CONTACTS_SUCESS,GET_CONTACT,TOGGLE_TRUE,TOGGLE_FALSE,VIDE_ERRORS} from '../Constants/ActionsTypes'
...
const contactReducer = (state = initState,{type,payload}) => {
    switch(type){
        ...
        case GET_CONTACT : return {...state, contact:payload}
